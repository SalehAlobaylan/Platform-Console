...
export const noteKeys = {
    ...
    customer: (customerId: string, params?: Pick<ListNotesParams, 'page' | 'limit'>) =>
 ...
 */
export function useCustomerNotes(customerId: string, params?: Pick<ListNotesParams, 'page' | 'limit'>) {
    return useQuery({
 ...
 */
export function useDealNotes(dealId: string, params?: Pick<ListNotesParams, 'page' | 'limit'>) {
    return useQuery({
