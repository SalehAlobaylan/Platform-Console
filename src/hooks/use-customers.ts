 ...
 * Uses optimized caching for list queries
 */
 ...
 * Uses optimized caching for detail queries
 */
...
export function useCreateCustomerContact() {
  ...
  return useMutation({
    mutationFn: ({
      ...
      customerId: string;
      data: Omit<CreateContactRequest, 'customer_id'>;
...
export function useUpdateContact() {
  ...
  return useMutation({
    ...
    onSuccess: (_, variables) => {
      ...
      queryClient.invalidateQueries({
        queryKey: customerKeys.contacts as unknown as string[],
      });
      toast({
...
export function useAssignCustomerTags() {
  ...
  return useMutation({
    ...
    onSuccess: (_, variables) => {
      queryClient.invalidateQueries({
        queryKey: customerKeys.tags(variables.customerId),
      });
      toast({
        title: 'Tags assigned',
