...
export const activityKeys = {
    ...
    list: (params: ListActivitiesParams) => [...activityKeys.lists(), params] as const,
    details: () => [...activityKeys.all, 'detail'] as const,
    detail: (id: string) => [...activityKeys.details(), id] as const,
    my: (params?: Omit<ListActivitiesParams, 'owner_id'>) => [...activityKeys.all, 'my', params] as const,
};
 ...
 */
export function useMyActivities(params?: Omit<ListActivitiesParams, 'owner_id'>) {
    return useQuery({
...
export function useCreateActivity() {
    ...
    return useMutation({
        ...
        onSuccess: () => {
            ...
            queryClient.invalidateQueries({ queryKey: activityKeys.my as unknown as string[] });
            toast({
